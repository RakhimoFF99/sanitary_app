      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
              ...
              itemBuilder: (context) => [
                PopupMenuItem(
                  child: Text(auth.phone.toString(),style: TextStyle(
                    color: Colors.black
                  ),),
                  value: 1,
                ),
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Ovqat".tr,style: TextStyle(
                      color: Colors.white,
                        fontSize: 20,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Desease()));
                  },
                  child: Container(
                    height: 70,
                    width: double.infinity,
                    ...
                    child: Center(child: Text('desease'.tr,style: TextStyle(
                      color: Colors.white,
                        fontSize: 20,
                        fontWeight: FontWeight.w600
                    ),),),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("medicine".tr,style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.w600
                    ),),),
