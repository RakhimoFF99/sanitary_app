            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      SizedBox(height: 30,),
                      Text("Dori-darmon tegishli tashkilotga jo'natish uchun formani to'ldiring",style: TextStyle(
                          fontSize: 20,
                      ...
                      SizedBox(height: 20,),
                      Text("Dori-darmon",style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.w600
                      ),),
                      SizedBox(height: 15,),
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              ...
                              onChanged: (value) {
                                ...
                                setState(() {
                                  this.medicine = value.toString();
                                });
                              },
                              items: this.medicines.map((String value) {
